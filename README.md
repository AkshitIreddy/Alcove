...
<!-- gen:badges -->
<p align="center">
  <a href="https://github.com/AkshitIreddy/Alcove/releases/latest"><img src="https://img.shields.io/badge/download-Alcove%200.7.9-c96f4a?style=flat-square&labelColor=4f3120" alt="Download Alcove 0.7.9"></a>
...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="#making-it-yours"><b>▸ Customize it</b></a>
  &nbsp;·&nbsp;
...
-->
<p align="center">
  <img src="docs/readme/img/demo.webp" alt="A loop through Alcove: a stocked walnut bookcase changes through named rooms, carpentry, wallpaper and colour schemes; the Welcome book opens into ruled pages; the tour visits book and page styling, the catalogue, contents, pictures, ribbons, diagrams, an optional assisted page draft, live writing and more page tools before the book closes into the same shelf where the loop began." width="880">
</p>

<p align="center">
  <sub>Every frame is the real app. Automated portions use frozen, reviewed fixtures and reversible app state rather than changing a reader's library. <a href="shots-now/demo-gif.mjs">How it is made</a> · built with <a href="https://www.npmjs.com/package/gifsmith">gifsmith</a></sub>
</p>

---

Alcove is built around the pleasure of keeping a library and writing in books:

- **Shelves you can build.** Add bookcases and floors, choose the carpentry and
  timber, hang a wallpaper, repaint the whole room and set the writing desk
  behind the open book.
- **Books you recognise.** Each book owns its binding, cloth or leather,
  colours, rules, emblem, cover, paper and page edges, and keeps that identity
  when it moves to another room.
- **Notes with a real page shape.** Fixed leaves flow into one another and hold
  ordinary writing alongside tables, code, maths, callouts, pictures, columns,
  keepsakes, stickers and hand-drawn diagrams.
- **A library that stays useful.** Search, contents, thumbnails, templates,
  page history, local backups, portable bundles and Markdown/PDF/image export
  are built in.
- **A room with a voice.** Choose from sound sets and ambience beds, mix their
  volumes independently or turn the whole soundscape off.
- **Private by default.** There is no account and the library stays on your
  computer. The in-book AI helper is optional and uses a key you provide.
...
> <br>The illustrated guide to shelves, books, pages, customization, sound,
> search, backups and every tool a reader can reach.
>
...
- [What's in the box](#whats-in-the-box) — The shelf, books, page editor, customization, sound and local ownership
...
## What's in the box
<!--nav: The shelf, books, page editor, customization, sound and local ownership-->

- **A customizable bookshelf world:** multiple bookcases, expandable floors,
  authored carpentry, timber patterns, wallpaper, room colours and writing
  desks.
- **Books with an identity:** recognisable bindings, cloth and leather,
  restrained spine decoration, complete covers, paper, ruling and page edges.
- **A rich notebook editor:** fixed pages, natural overflow, text, lists,
  tables, code, maths, cards, callouts, pictures, columns, keepsakes, stickers
  and hand-drawn diagrams.
- **Ways to find and protect work:** whole-library search, `Ctrl+K`, contents,
  thumbnails, templates, protected history, scheduled backups and portable
  `.nbk` bundles.
- **A personal atmosphere:** handwriting, ink, ribbons, decorative effects,
  sound sets, ambience beds and independently mixed volumes.
- **Local-first ownership:** no account, no cloud library, Markdown/PDF/image
  export, plus an optional AI helper for readers who choose to connect one.
...
| Platform | Take |
| --- | --- |
| **Windows 10 / 11** | [`Alcove_0.7.9_x64-setup.exe`](https://github.com/AkshitIreddy/Alcove/releases/latest) · about 16 MB |
| **macOS 11+** | [`Alcove_0.7.9_universal.dmg`](https://github.com/AkshitIreddy/Alcove/releases/latest) · Apple silicon and Intel |
...
![The optional AI Agent showing a reviewed set of pages beside the open book.](docs/readme/img/agent.png)
...
| --- | --- | --- |
| Frontend source | <!--f:srcFiles-->391<!--/f--> TypeScript files, <!--f:srcDocstrings-->350<!--/f--> of which open with a module docstring — <!--f:docstringLines-->7366<!--/f--> lines of prose | [What the source files document about themselves](#what-the-source-files-document-about-themselves) |
| Rust host | <!--f:rustFiles-->11<!--/f--> files, <!--f:rustLines-->7903<!--/f--> lines, <!--f:rustCommands-->29<!--/f--> commands, <!--f:dbMigrations-->2<!--/f--> migrations | [How it's built](#how-its-built) |
