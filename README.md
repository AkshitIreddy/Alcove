...
| --- | --- | --- |
| Frontend source | <!--f:srcFiles-->382<!--/f--> TypeScript files, <!--f:srcDocstrings-->345<!--/f--> of which open with a module docstring — <!--f:docstringLines-->7325<!--/f--> lines of prose | [What the source files document about themselves](#what-the-source-files-document-about-themselves) |
