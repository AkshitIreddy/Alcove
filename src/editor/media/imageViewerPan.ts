...
export type ViewerWheelAction = { readonly kind: 'zoom'; readonly delta: number };
...
/**
 * Interpret mouse-wheel or precision touchpad input for the inspection desk.
 * Rotation zooms, as it does in the focus workspace; travel belongs to an
 * explicit middle-button drag. Browser pinch gestures arrive as Ctrl+wheel
 * and use the same deliberately small, bounded zoom steps.
 */
 ...
 * spatial scratch area. `Center` is the recovery affordance. The old
